...
export function useAffixOverrides() {
...
export function materializeOverride(pattern, value) {
    if (!pattern)
        return null;
    if (isHideToken(pattern))
        return "";
...
export function findPhraseOverride(label, overrides) {
